 ...
 */
package org.sonar.plugins.gosu.surefire;
 ...
 */
public class GosuSurefireParserTest {

  private ResourcePerspectives perspectives;
  private FileSystem fs;
  private GosuSurefireParser parser;
  private Gosu gosu;
  ...
  public void before() {
    ...
    parser = spy(new GosuSurefireParser(gosu, perspectives, fs));
 ...
 /* @Test
  ...
  private java.io.File getDir(String dirname) throws URISyntaxException {
    return new java.io.File("src/test/resources/org/sonar/plugins/gosu/surefire/SurefireParserTest/" + dirname);
  }
  ...
  public void should_generate_correct_predicate() throws URISyntaxException {
    ...
    assertThat(context.measure(":src/test/org/sonar/JavaNCSSCollectorTest.gosu", CoreMetrics.TESTS).value()).isEqualTo(11);
  }
