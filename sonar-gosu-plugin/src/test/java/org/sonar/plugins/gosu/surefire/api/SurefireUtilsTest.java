 ...
 */
package org.sonar.plugins.gosu.surefire.api;
...
public class SurefireUtilsTest {
  ...
  @Before
  public void setup() {
    fs = new DefaultFileSystem(new File("src/test/resources/org/sonar/plugins/gosu/surefire/api/SurefireUtilsTest/shouldGetReportsFromProperty"));
